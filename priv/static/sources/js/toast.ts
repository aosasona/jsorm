...
export function error(body: string, duration: Duration = "3s") {
  show(body, "error", duration);
}

export function warning(body: string, duration: Duration = "3s") {
  show(body, "warning", duration);
}

export function success(body: string, duration: Duration = "3s") {
